...
def run_experiments_with_multiple_ues(index):
    packet_lengths = [500]
    ue1_mb_values = [1000]#[10,50,150,250,500,1000]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,30,50,100,200]
    ue2_mb_values = [1000]#[10,50,150,250,500,1000]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,20,50,100,200]
    ...
    for packet_length in packet_lengths:
        for ue1_mb, ue2_mb in zip(ue1_mb_values, ue2_mb_values):
            ...
            experiment_dir = f"experiment_packet_energy_2UE_2CU_tcp_iperf-n_{index}/{total_mb}_{packet_length}"
