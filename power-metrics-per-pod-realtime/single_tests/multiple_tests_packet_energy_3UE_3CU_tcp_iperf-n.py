...
def run_experiments_with_multiple_ues(index):
    packet_lengths = [500]
    ue1_mb_values = [333]#[6,33,100,166,333,666]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,30,50,100,200]
    ue2_mb_values = [333]#[6,33,100,166,333,666]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,20,50,100,200]
    ue3_mb_values = [334]#[8,34,100,168,334,668]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,20,50,100,200]

    duration_baseline = 25
    tcpdump = False

    for packet_length in packet_lengths:
        for ue1_mb, ue2_mb, ue3_mb in zip(ue1_mb_values, ue2_mb_values, ue3_mb_values):
            print("\n------------------------------NEW EXPERIMENT------------------------------")
            ...
            while not deployment_succeeded:
                ...
                deployment_succeeded = (
                    ...
                    check_ping(oai_nr_ue3_pod, RAN_NAMESPACE, "12.1.1.102") 
                )

            apply_tc_rule_to_cu(max_rate=50)

            total_mb = ue1_mb + ue2_mb + ue3_mb
            experiment_dir = f"experiment_packet_energy_3UE_3CU_iperf-n_{index}/{total_mb}_{packet_length}"
