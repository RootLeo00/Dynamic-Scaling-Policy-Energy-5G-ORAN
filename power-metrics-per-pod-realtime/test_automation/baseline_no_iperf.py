...
import threading
import time
from utils import collect_metrics, get_pod_info, get_all_pod_names, create_uid_pod_mapping,check_ping, plot_metrics
import logging
...
def run_experiments(): 
    ...
    experiment_dir = f"baseline_metrics"
    ...
    try:
        ...
        time.sleep(180) # wait for stabilization
