...
def run_experiments_with_multiple_ues(index):
    packet_lengths = [500]
    ue1_mb_values = [6,33,100,166,333,666]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,30,50,100,200]
    ue2_mb_values = [6,33,100,166,333,666]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,20,50,100,200]
    ue3_mb_values = [8,34,100,168,334,668]#range(100,400,100)# [10,50,100,200]#[10,30,50,70,90,110,130,]#[10,20,50,100,200]
